                                ...
                                <table id='datatable' class='table table-hover'>
                                    <thead>
                                        <tr>
                                            ...
                                            <th><i class='icon-signal'></i> Harga2/Kg</th>
					...
					<input type='hidden' name='id' value='$r[id]'>
					 <div class='control-group'>
					   ...
					   <div class='form-group'>
                            ...
                            <div class='span9'><input class='form-control' size='16' type='number' value='$r[harga2]' name='harga2' /></div>
                        </div>
					<Br>

			<input type='submit' class='btn btn-primary' value='Update'> <a class='btn btn-danger' href='?p=harga2'>Batal</a>
		  </form>
		</div> 
...
case "tambah":
    ...
    echo '<div class="panel panel-border panel-primary">
                         ...
                         <div class="control-group">
                           ...
                           <div class="form-group">
                                <label>Harga2/Kg</label>
                                <div class="span9"><input class="form-control" size="16" type="number" placeholder="Masukan Harga2 Laundry" name="harga2" /></div>
                            </div>				 
                        <Br>

        ...
        <div id="wrapper">
            ...
            <div id="sidebar-menu">
                <ul>
					...
					<li>
                        <a href="?p=tambahko" class="waves-effect"><i class="fa fa-user-plus"></i><span>Konsumen </span></a>
                    </li>
                    
                    <?php } ?>
                    <li>
                        <a href="?p=dataord" class="waves-effect"><i class="fa fa-clock-o"></i><span>Pesanan Masuk</span></a>
                    </li>
                    ...
                    <?php if ($hasil['level']=='Owner') {?>
                        <li class="has_sub">
                        <a href="#" class="waves-effect"><i class="fa fa-user"></i> <span> Administrasi Menu </span> <span class="pull-right"><i class="md md-add"></i></span></a>
                            <ul class="list-unstyled">
                                
                                
                                <li><a href="?p=tambaha">Tambah Admin/CEO</a></li>
                                <li><a href="?p=tambahk">Tambah Karyawan</a></li>
                                <li hidden><a href="?p=tambahs">Tambah Supplier</a></li>

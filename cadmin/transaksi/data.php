        ...
        <table style="border-style: solid; border-width: thin;" id='datatable' class='table table-hover'>
            <thead>
                <tr>
					...
					<th colspan="2"><i class='icon-terminal'></i> Jenis Satuan</th>
					<th><i class='icon-signal'></i> Tarif Kiloan</th>
					<th colspan="2"><i class='icon-signal'></i> Tarif Satuan</th>
					<th><i class='icon-signal'></i> Total Satuan dan Kiloan</th>
					<th><i class='icon-signal'></i> Berat Kiloan</th>
					<th colspan="2"><i class='icon-signal'></i> Total Satuan</th>

					<th><i class=''></i> Tanggal Transaksi</th>
...
?>
	<tr>
        ...
        <td><?php echo $data['jenis3'];?></td>
		<td><?php echo'Rp.' . number_format( $data['tarif'], 0 , '' , '.' ) . ',-'?></td>
		<td><?php echo'Rp.' . number_format( $data['tarif2'], 0 , '' , '.' ) . ',-'?></td>
		<td><?php echo'Rp.' . number_format( $data['tarif3'], 0 , '' , '.' ) . ',-'?></td>
		<td><?php echo'Rp.' . number_format( $data['jumlah'], 0 , '' , '.' ) . ',-'?></td>
		<td><?php echo $data['berat']  ?> <?php echo $data['kg']	?></td>
		<td><?php echo $data['satuan'] ?> <?php echo $data['pcs']	?></td>
		<td><?php echo $data['satuan2']?> <?php echo $data['pcs']	?></td>

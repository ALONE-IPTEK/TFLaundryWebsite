...
echo "<div class='panel panel-border panel-primary'>
                                ...
                                <table id='datatable' class='table table-hover'>
                                    ...
                                    <tbody>";
							$i=1;
							$tp=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM barangg ORDER BY id");
...
break;
case "edit":
	$edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM barangg WHERE id='$_GET[id]'");
...
echo '<div class="panel panel-border panel-primary">
					 ...
					 <div class="control-group">
                            ...
                            ';
							$tp=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM supplier ORDER BY id");
							while($r=mysqli_fetch_array($tp)){

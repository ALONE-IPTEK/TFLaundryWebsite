...
echo "<div class='panel panel-border panel-primary'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Data Jenis Laundry Kiloan</h3> 
                                ...
                                <table id='datatable' class='table table-hover'>
                                    ...
                                    <tbody>";
							$i=1;
							$tp=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM jenis ORDER BY id");
...
echo "<div class='panel panel-border panel-primary'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Edit Jenis Laundry Kiloan</h3> 
                                    </div>  <div class='panel-body'> 
...
case "tambah":
    ...
    echo '<div class="panel panel-border panel-primary">
                                        <div class="panel-heading"> 
                                            <h3 class="panel-title"><i class="fa fa-list"></i> Tambah Jenis Laundry Kiloan</h3> 
                                        </div>  <div class="panel-body"> 
                         <div class="control-group">
                           <div class="form-group">
                                <label>Jenis</label>

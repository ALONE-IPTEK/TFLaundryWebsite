...
echo "<div class='panel panel-border panel-primary'>
		 ...
		 <hr>
                                <table id='datatable' class='table table-hover'>
                                    ...
                                    <tbody>";
							$i=1;
							$tp=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengguna WHERE level='Konsumen' ORDER BY id");
...
break;
case "edit":
	$edit = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengguna WHERE id='$_GET[id]'");

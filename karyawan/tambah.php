...
$cekuser = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM pengguna WHERE username = '$username'");  
 ...
 echo "ERROR : Username sudah terdaftar";
	...
	$input = mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO pengguna VALUES(NULL, '$nama','$username', '$password', 'Karyawan', '$nik', '$alamat', '$telp', '$gender')") or die(mysqli_error($GLOBALS["___mysqli_ston"]));
	if($input){

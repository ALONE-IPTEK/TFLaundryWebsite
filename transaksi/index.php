...
?>
	<form method="post">
		...
		<div class="form-group">
        	<label>Jenis</label>
				...
				<option value=""></option>
					...
					?>
				<option required value="<?php echo $r3['jenis2'];?>"><?php echo $r3['jenis2'];?></option>
				<?php } ?>
				</select>
		</div>

		<div class="form-group">
        	<label for="desimal">Berat (Dalam <i style="color: blue;">Kilogram</i>)</label>
        	<!-- <input type="text" class="form-control number" name="berat" placeholder="Masukan Berat Pakaian(Pakai Angka)" required> -->
			<input type="text" class="form-control harga" id="desimal" name="berat" placeholder="Masukan Berat Pakaian(Pakai Angka)" required>
    	</div>
		...
		<div class="form-group">
			...
			<input type="date" class="form-control" id="inputdate" name="tgl_ambil" min="today" max="+30d" required>
		</div>

...
require("../koneksi.php");
$query = mysqli_query($conn, "SELECT * FROM transaksi2 WHERE id='$_GET[id]'");
$hasil = mysqli_fetch_array($query);
$hhh=$hasil['konsumen'];
$query2 = mysqli_query($conn, "SELECT * FROM konsumen WHERE username='$hhh'");
...
$cash=$hasil['jumlah'];
$nota=$hasil['nota'];
$pembayar=$hasil['jenis_laundry'];
$tglambil= TanggalIndo($hasil['jenis_pembayaran']);
$tgltransaksi= TanggalIndo($hasil['tgl_order']);

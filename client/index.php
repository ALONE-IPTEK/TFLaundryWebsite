...
<html>
    ...
    <body data-spy="scroll" data-target=".navbar" class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="?p=tambaht" class="waves-effect"><i class="fa fa-plus"></i><span> Buat Order </span></a>
                    </li>
					<li>
                        <a href="?p=riwayatt" class="waves-effect"><i class="fa fa-clock-o"></i><span> Riwayat Order </span></a>
                    </li>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyARhWUhoaMVsNvTFf2rXbW3sIFSk_tLUKk&callback=initialize"></script>
